  		...
  		<div class="member_wrp">
            ...
            <div class="mT40 join_frm">
               ...
               <div class="mT40">
               		...
               		<p class="mT10"><input type="checkbox"><label for=""><span class="ico"></span>이용약관에 동의합니다.</label> <span class="f_red">(필수)</span></p>
                    <p class="mT20"><textarea style="width:100%; height:120px;">개인정보처리방침</textarea></p>
                    <p class="mT10"><input type="checkbox"><label for=""><span class="ico"></span>개인정보처리방침에 동의합니다.</label> <span class="f_red">(필수)</span></p>
               </div>
            </div><!-- gy_box1 -->
			<div class="btn_wrp">
