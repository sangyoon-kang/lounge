...
<div id="all_wrp">
	<div id="wrapper">
		...
		<div id="container">
			<div id="title">
				<div class="fleft">
					<h2><strong>웹사이트</strong></h2>
					<div class="tit_ex">솔루션의 선두주자! 타고플러스</div>
				</div>
				<div class="fright location"><img src="/images/ic_home.png" /> > 포트폴리오 > 웹사이트</div>
			</div><!--  end title -->
			<div id="content">
			
				<jsp:include page="/module/board.do" flush="true"><jsp:param name="bcode" value="portfolio" /></jsp:include>			
