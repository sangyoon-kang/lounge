...
<script type="text/javascript">
	...
	function initOnReady() {
		var widget = window.tvWidget = new TradingView.widget({
			...
			datafeed: new Datafeeds.UDFCompatibleDatafeed("http://211.43.12.145:8888",1000),
	...
	<div class="scon">
		...
		<div class="trade_con01">
			...
			<ul class="m_none">
				...
				<li><span>종목</span><strong>BTCUSDT</strong></li>
			...
			<ul class="m_block">
				...
				<li><span>종목</span><strong>BTC / USDT.M</strong></li>
				<li><span>보유보증금</span><strong class="txt_blue userCash" ><fmt:formatNumber
						pattern="#,##0" value="${cash}" /></strong></li>
			</ul>
		</div>
					...
					<table>
						...
						<c:forEach items="${resultList}" var="m" varStatus="s">
							<tr>
								...
								<fmt:formatNumber var="rEval" value="${m.eVal }" pattern=".00" />
