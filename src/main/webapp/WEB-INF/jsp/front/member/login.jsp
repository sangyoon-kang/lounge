	...
	<section class="wrap_scon">
		<div class="scon">
			<div class="section_login">
				<ul class="login_p01">
					<li><input name="userId" type="text" placeholder="아이디" onkeypress="if(event.keyCode==13)javascript:doLogin(event);"/></li>
					<li><input type="password" id="user_pass" name="userPwd" placeholder="비밀번호" onkeypress="if(event.keyCode==13)javascript:doLogin(event);" required/></li>
					<li><a href="#" onClick="javascript:doLogin(event);">로그인</a></li>
				</ul>
				<ul class="login_p01_aside">
					<li><a onclick="window.open('/mypage/id_search',
                               'login_popup.do', 'width=640,height=400,top=50, left=600,location=no,status=no,scrollbars=yes');">아이디 찾기</a></li>
					<li><a onclick="window.open('/mypage/id_search',
                               'login_popup.do', 'width=640,height=400,top=50, left=600,location=no,status=no,scrollbars=yes');">비밀번호 찾기</a></li>
