...
<style>
	#cke_1_bottom, #cke_2_bottom, #cke_3_bottom {display:none;}
	#cke_1_top, #cke_2_top, #cke_3_top  {display:none;}
	.cke_editable {padding:10px; display:none;}
	#register-agree textarea {display:none;}
</style>
...
<div class="scon">
		<form name="joinForm" id="joinForm" method="post" action="/join" style="display:none;">
			...
			<ul class="join_list">
					<li>아이디</li>
					<li>
					<input type="text" min="6" id="userId" maxlength="20" name="userId" placeholder="아이디를 입력하세요." class="join_input01"/><a onClick="javascript:doCheck();" class="join_bt01">중복체크</a>
			...
			<ul class="join_list">
					<li>이름</li>
					<li>
					<input type="text"  id="user_name"  maxlength="100" name="userName" value="${search.userName }" class="join_input01 " readonly style="background-color: rgb(218, 218, 218);"/><a onclick="javascript:ipinCheck();" class="join_bt01">본인인증 </a> 
					<span class="join_txt_red small bold" id="userNameChk" style="display:none;">이미 등록되어 있습니다.</span>
					</li>
			...
			<ul class="join_list">
					...
					<li>
						...
						<input type="text"  maxlength="3" class="join_input02" id="phone1" name="phone1" readonly style="background-color: rgb(218, 218, 218);"/><span class="join_bar_txt">
						-</span><input type="text"  maxlength="4" class="join_input02" id="phone2" name="phone2" readonly style="background-color: rgb(218, 218, 218);"/><span class="join_bar_txt">
						-</span><input type="text" maxlength="4" class="join_input02"  id="phone3" name="phone3" readonly style="background-color: rgb(218, 218, 218);"/>
						
					<input type="hidden"  id="user_mobile_number"  maxlength="24" name="phone" readonly value="${search.phone }" placeholder="휴대폰" >
					<span class="join_txt_red small bold" id="userMobileChk" style="display:none;">이미 등록되어 있습니다.</span>
					</li>
				</ul>
				<ul class="join_list">
					<li>비밀번호</li>
				...
				<ul class="join_list">
					<li>예금주</li>
					<li>
					<input type="text" class="join_input01 join_input01_01" value="" id="user_account_holder" maxlength="8" name="accountOwner"placeholder="예금주명" readonly />
...
<!-- 				<ul class="join_list">
				...
				<ul class="join_list">
					<li>계좌번호</li>
					<li>
					 <input type="text" placeholder="계좌번호 입력" class="join_input01 onlyNumber" id="user_account_number" maxlength="24" name="bankAccount"/>
				...
				<ul class="join_list">
					<li>이메일</li>
					<li>
					<input type="text" class="join_input02" maxlength="24" id="email1"/><span class="join_bar_txt join_bar_txt02">
					@</span><input type="text" class="join_input02" id="email2"/><select class="join_select join_select03" id="emaildom">
					...
					<input type="hidden" class="form-control" id="user_email" name="email" maxlength="24" placeholder="이메일">
					</li>
				</ul>
			...
			<div class="join_agree_box">
				...
				<p><label><input type="checkbox" name="checks" id="condition"/><span>개인정보 처리 방침 내용에 동의합니다.</span></label></p>
			</div>
