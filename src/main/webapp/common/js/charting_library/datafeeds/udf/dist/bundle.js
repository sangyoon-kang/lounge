! function(e, t) {
    ...
    function o(e, t) {
        this._subscribers = {}, this._requestsPending = 0, this._historyProvider = e, setInterval(this._updateData.bind(this), 1000)
    }
    ...
    e.UDFCompatibleDatafeed = x, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});